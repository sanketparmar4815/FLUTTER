...
class _UpdateState extends State<Update> {
  ...
  void initState() {
    ...
    super.initState();
    hname.text = widget.pda['NAME'];
    hcontactnumber.text = widget.pda['CONTACTNUBER'];
  }
                        ...
                        child: ElevatedButton(
                            ...
                            onPressed: () {
                              MyDataBase().updatedata(
                                  ...
                                  hname.text,
                                  hcontactnumber.text,
                                  widget.pda['ID']).then((value) => Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) {
                                    return homepage();
                                  },)));
                            },
                            child: Text("Update")),
