        ...
        body: Container(
          ...
          child: Stack(children: [
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                      ...
                      suffixIcon:Visibility(
                        ...
                        }, icon:Icon(Icons.remove_red_eye, color: Color(0xff060047)),
                        ),
                      ),
            ...
            Positioned(
                ...
                onPressed: () {
                  setState(() {
                    print("-------------tap on sign in button ---------------");
                    MyDataBase().forlogindata(mailid.text,password.text,signin.db!).then((value){
            ...
            Positioned(
                ...
                child: Text("Forgot Password?",
                    style: TextStyle(
                        color: Color(0xff7A86B6), fontWeight: FontWeight.bold))),
            Positioned(
                width: 300,
                height: 50,
                top: 570,
